...
```{r ana-guess, fig.cap="(ref:ana-guess)", fig.height=5.5, fig.width=4, fig.align="center"}
ana <- Sys.glob(here("data/derived_data/perfiles_ana_era5_E*.csv")) %>% 
  map_df(function(f) {
...
gue <- Sys.glob("~/datosmunin3/EXP/derived_data/perfiles_guess_era5_E*.csv") %>% 
  map_df(function(f) {
