...
\centering
\begin{tabu} to \linewidth {>{\raggedright\arraybackslash}p{10em}>{\raggedright\arraybackslash}p{16em}>{\centering\arraybackslash}m{4em}>{\centering\arraybackslash}m{4em}}
\toprule
