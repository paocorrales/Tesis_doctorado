...
(ref:era5-fcst-q) Cómo en la Figura \@ref(fig:era5-fcst-1) pero para la humedad específica ($gkg^{-1}$).
...
(ref:era5-fcst-v) Cómo en la Figura \@ref(fig:era5-fcst-1) pero para el viento meridional ($ms^{-1}$).

(ref:era5-fcst-u) Cómo en la Figura \@ref(fig:era5-fcst-1) pero para el viento zonal ($ms^{-1}$).
...
front %>% 
  ...
  labs(color = NULL) +
  facet_grid(date ~ lev, labeller = labeller(lev = c("1000" = "1000 hPa",
                                                     "900" = "900 hPa",
                                                     "800" = "800 hPa"),
